<script lang="ts">
     ...
     * 
     * Makes an HTTP request to the /api/games endpoint and updates the component state
     * with the retrieved games data. Handles loading states and error conditions.
     * 
