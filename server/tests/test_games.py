...
class TestGamesRoutes(unittest.TestCase):
    ...
    def test_create_game_invalid_publisher(self) -> None:
        """Test creation fails with invalid publisher_id"""
        # Arrange
        new_game_data = {
            "title": "Test Game",
            "description": "A test game for unit testing",
    ...
    def test_create_game_invalid_category(self) -> None:
        """Test creation fails with invalid category_id"""
        # Arrange
        new_game_data = {
            "title": "Test Game",
            "description": "A test game for unit testing",
    ...
    def test_create_game_invalid_title_length(self) -> None:
    ...
    def test_update_game_invalid_publisher(self) -> None:
        """Test update fails with invalid publisher_id"""
        # Get first game ID
        response = self.client.get(self.GAMES_API_PATH)
        games = self._get_response_data(response)
        game_id = games[0]['id']
    ...
    def test_update_game_no_json_data(self) -> None:
        """Test update fails with no JSON data"""
        # Get first game ID
        response = self.client.get(self.GAMES_API_PATH)
        games = self._get_response_data(response)
        game_id = games[0]['id']
